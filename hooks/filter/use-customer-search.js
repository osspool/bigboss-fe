...
export function useCustomerSearch() {
  ...
  const config = {
    ...
    filterFields: {
      gender: { paramName: "gender", type: "string", defaultValue: "" },
    },
  ...
  const gender = baseSearch.filters.gender || "";
  const setGender = (value) => baseSearch.updateFilter("gender", value);
