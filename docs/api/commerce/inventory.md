...
| `createTransaction` | boolean | No | Create expense transaction (default: false) |
| `transactionData` | object | No | Transaction details (only used if createTransaction: true) |
